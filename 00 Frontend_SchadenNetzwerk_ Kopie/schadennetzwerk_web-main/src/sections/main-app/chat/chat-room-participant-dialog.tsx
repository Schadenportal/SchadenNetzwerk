    ...
    <Dialog fullWidth maxWidth="xs" open={open} onClose={onClose}>
      ...
      <DialogContent sx={{ py: 5, px: 3, display: 'flex' }}>
        ...
        <Stack spacing={1}>
          ...
          <Typography variant="subtitle1">{participant.fullName || `${participant.firstName} ${participant.lastName}`}</Typography>
          ...
          <Stack direction="row" sx={{ typography: 'caption', color: 'text.disabled' }}>
            ...
            />
            {`${participant?.street || ""} ${participant?.postalCode || ""} ${participant?.city || ""}`}
          </Stack>
