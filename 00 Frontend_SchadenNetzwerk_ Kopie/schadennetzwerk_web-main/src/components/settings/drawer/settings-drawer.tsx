...
export default function SettingsDrawer() {
  ...
  const renderHead = (
    <Stack
      ...
      sx={{ py: 2, pr: 1, pl: 2.5 }}
    >
      <Typography variant="h6" sx={{ flexGrow: 1 }} color="text.tableText">
        Settings
      </Typography>
  ...
  const renderMode = (
    <div>
      <Typography variant="caption" component="div" sx={{ ...labelStyles, color: (theme1) => theme1.palette.text.tableText }}>
        Mode
      </Typography>
      ...
      <BaseOptions
        ...
        options={['light', 'dark', 'blue', 'green', 'stellantis', 'red']}
        icons={['sun', 'moon', 'blue', 'green', 'stellantis', 'red']}
      />
    </div>
  );
